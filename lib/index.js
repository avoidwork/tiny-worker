...
var Worker = function () {
	function Worker(arg) {
		...
		this.child.on("exit", function (code, signal) {
			if (_this.expectingSigInt && signal === "SIGINT" || !_this.onerror) return;
			if (code !== 0 && code !== null) _this.onerror.call(_this, new Error("Exit code " + code));
			if (signal) _this.onerror.call(_this, new Error("Terminated with signal " + signal));
		});
